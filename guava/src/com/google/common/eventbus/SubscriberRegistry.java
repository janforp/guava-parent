...
final class SubscriberRegistry {
     ...
     *
     * key:event的class类型
     * value:该event类型的感兴趣的方法(@Subscribe方法)
     */
    ...
    void register(Object listener) {
        /**
         * 通过反射方式拿到该对象中所有的订阅方法{@link Subscribe}
         *
         * 事件类型 - 该类型事件的订阅者集合
         * 一个类型的 event 可以有多个订阅者方法
         */
     ...
     *
     * @param listener {@link Subscribe} 方法所在的对象
     * @return 返回解析之后封装的 事件类型 - 该类型事件的订阅者集合
     */
